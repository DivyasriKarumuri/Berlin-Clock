...
public class BerlinClockFixture {
    ...
    public void thenTheClockShouldLookLike(String theExpectedBerlinClockOutput) {
    	String computedBerlinClockTime= berlinClock.convertTime(theTime).replaceAll("[\\t\\r ]", "");
    	theExpectedBerlinClockOutput = theExpectedBerlinClockOutput.replaceAll("[\\t\\r]", "");
        assertThat(computedBerlinClockTime).isEqualTo(theExpectedBerlinClockOutput);
    }
